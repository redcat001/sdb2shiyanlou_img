...
for(var i=0;i<serverName.length;i++){
  ...
  rg.createNode(serverName[i], 11810, path+"/sequoiadb/database/coord/11810",{globtranson:true,mvccon:true,transisolation:3,diaglevel:4,logfilenum:5,transactionon:true});
